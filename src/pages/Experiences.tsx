...
const Experiences = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      duration: "6 horas",
      maxPeople: 6,
      description: "Aprende la técnica ancestral del tejido Wayuu con artesanas expertas.",
    ...
    },
    {
      ...
      duration: "3 horas",
      maxPeople: 12,
      description: "Observa especies endémicas en su hábitat natural con guías expertos.",
      provider: "EcoTurismo Andino",
    ...
    },
    {
      ...
      duration: "5 horas",
      maxPeople: 10,
      description: "Prepara platos ancestrales con ingredientes de la selva amazónica.",
      provider: "Comunidad Tikuna",
      features: ["Ingredientes locales", "Receta tradicional", "Almuerzo incluido"]
    },
    {
      id: 5,
      title: "Navegación en Canoa Tradicional",
      ...
      duration: "4 horas",
      maxPeople: 8,
      description: "Navega por manglares vírgenes en canoas construidas por comunidades locales.",
      provider: "Manglares del Pacífico",
    ...
    },
    {
      ...
      duration: "8 horas",
      maxPeople: 4,
      description: "Participa en ceremonia de sanación con plantas medicinales ancestrales.",
